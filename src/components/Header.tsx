        ...
        >
          ...
          <div className="hidden md:flex">
            <a 
              ...
              className="bg-blue-600 hover:bg-blue-700 text-white px-5 lg:px-6 py-2 rounded-lg transition-colors duration-200"
            >
              Hire Me
            </a>
          </div>
            ...
            <nav className="flex flex-col space-y-2">
              {navItems.map((item) => (
                <button
                  key={item.label}
                  onClick={() => scrollToSection(item.href)}
                  className="text-gray-300 hover:text-blue-400 transition-colors duration-200 flex items-center gap-2 py-3 px-2 rounded-md"
                >
                  {item.icon}
                  {item.label}
                </button>
              ...
              <a 
                href="#contact" 
                onClick={(e) => { e.preventDefault(); scrollToSection('#contact'); }}
                className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg transition-colors duration-200 mt-4 text-center"
              >
                Hire Me
              </a>
            </nav>
